-- ===========================================================================
--  OPCIONAL — Notificaciones con la app CERRADA (Web Push)
--
--  NO ejecutes esto todavia. Requiere pasos previos que estan comentados
--  mas abajo (guardar 2 secretos en el Vault de Supabase).
--  La app funciona perfectamente sin esto: avisa mientras esta abierta.
-- ===========================================================================

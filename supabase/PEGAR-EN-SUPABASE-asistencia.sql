-- ===========================================================================
--  CHECKLIST PERSONAL - Control de asistencia por materia
...
--  QUE HACE
--  --------
--  1. Añade `max_absences` a `subjects`: cuantas faltas admite cada asignatura
--     antes de reprobar. Lo pones tu; vacio significa "sin limite".
--  2. Crea `class_attendance`, con una fila por clase MARCADA -no por clase que
--     existe-, para poder decirte "te quedan 3 faltas" en vez de un porcentaje.
--
--  PEGA ESTO ANTES DE ACTUALIZAR LA APP, como la vez anterior: la columna nueva
--  va sobre `subjects`, que ya esta en uso.
--
--  Hace falta haber ejecutado antes PEGAR-EN-SUPABASE-horario.sql.
-- ===========================================================================
